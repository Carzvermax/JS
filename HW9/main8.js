...
//     let div = document.createElement('div')
//     div.innerHTML = `<div class="title">${coursesArrayElement.title}</div> <div class="monthDuration">${coursesArrayElement.monthDuration}</div>
//  <div class="hourDuration">${coursesArrayElement.hourDuration}</div>`
...
let age = document.forms.f1.value
console.log(age);
